...
<div class="jumbotron">
<h1>Edit Manager's Profile <a class="nav-link" href="edit(manager).php"><i class="fas fa-edit"></i></a></h1>
</div>
<form action="edit(manager).php" method="post">

        Name: <input type="text" name="name" value='<?php echo $_SESSION["manager_name"];?>'><br><br>
        
        
    
   Email: <input type="text" name="email" value='<?php  echo $_SESSION["manager_email"];?>'><br><br>        
